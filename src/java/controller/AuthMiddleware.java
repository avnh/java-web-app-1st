...
public class AuthMiddleware implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("AuthMiddleware:DoBeforeProcessing");
        }
        try {
            // exclude /login request
            String url = request.getRequestURI();
            String staticPath = request.getContextPath() + "/templates/";
            String welcomePath = request.getContextPath() + "/welcome";
            String loginPath = request.getContextPath() + "/login";
            String registerPath = request.getContextPath() + "/register";
//        log(url);
//        log(loginPath);
//        log(registerPath);
            ...
            if (url.equals(loginPath) || url.equals(registerPath)) {
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("AuthMiddleware:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("AuthMiddleware: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("AuthMiddleware(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("AuthMiddleware::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("AuthMiddleware::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("AuthMiddleware::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("AuthMiddleware::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("AuthMiddleware::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
